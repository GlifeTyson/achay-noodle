...
const Info = () => {
  ...
  return (
    <div className="w-full h-full p-4 md:p-6 text-playfair">
      <div className="flex flex-col items-center w-full h-full rounded-md border-2 border-dashed border-black p-4 gap-3">
        <span className="text-xl md:text-3xl font-medium">
          {t("openingTime")}
        </span>
        <p>-------------------</p>
        <div className="flex flex-col h-1/2 lg:h-[50vh] justify-center items-center">
          <div className="flex flex-col items-center gap-3 mt-5 lg:mt-10 font-medium">
            <p className="text-lg md:text-2xl">{t("landingTitle")}</p>
            <p className="text-sm md:text-base">{t("address")}</p>
          </div>
          <div className="text-sm md:text-base mt-5 lg:mt-10 mx-auto">
            <p>{t("dayofweek")}</p>
            <p>
